        ...
        <div className="app-ecommerce">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
            <div className="d-flex flex-column justify-content-center">
              <h4 className="mb-1 mt-3">Ipd Add Patient</h4>
            </div>
          </div>
          <div className="row">
                  ...
                  >
                    ...
                    <Row className="mb-3">
                      ...
                      >
                        ...
                        <Form.Control.Feedback type="invalid">
                          Please select a Symptoms Title.
                        </Form.Control.Feedback>
                      </Form.Group>
                    </Row>
                    ...
                    <div className="p-3" style={{ backgroundColor: "#f3f3f3" }}>
                      ...
                      <Row className="mb-3">
                        ...
                        >
                          ...
                          <Form.Control as="select" required>
                            ...
                            <option value="Yes">Star Health insuarance</option>
                          </Form.Control>
                          <Form.Control.Feedback type="invalid">
                            Please select a Casualty.
                          </Form.Control.Feedback>
                        ...
                        >
                          ...
                          />
                          <Form.Control.Feedback type="invalid">
                            Please provide a valid Credit Limit .
                          </Form.Control.Feedback>
                        </Form.Group>
                      ...
                      <Row className="mb-3">
                        ...
                        <Form.Group
                          ...
                          controlId="validationCustom07"
                        >
                          <Form.Label>Live Consult</Form.Label>
                          <Form.Control as="select" required>
                            <option value="">Select</option>
                            <option>VIP Ward Ground Floor</option>
                            <option>Private Ward 3rd Floor</option>
