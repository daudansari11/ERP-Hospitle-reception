      ...
      <Form noValidate validated={validated} onSubmit={handleSubmit}>
        ...
        <Row className="mb-3">
          ...
          >
            ...
            <Form.Select required aria-label="Select Blood Group">
              <option value="">Choose...</option>
              <option value="consultation">B+</option>
              <option value="consultation">A+</option>
            </Form.Select>
            <Form.Control.Feedback type="invalid">
              Please select an Blood Group.
            </Form.Control.Feedback>
          </Form.Group>
          ...
          >
            ...
            <Form.Select required aria-label="Select Blood Donor">
              <option value="">Choose...</option>
              <option value="consultation">Brian</option>
              <option value="follow-up">Addy</option>
              <option value="follow-up">madhav</option>
            </Form.Select>
            <Form.Control.Feedback type="invalid">
              Please select an Blood Donor.
            </Form.Control.Feedback>
          </Form.Group>
...
export default BloodDonorReporForm;
