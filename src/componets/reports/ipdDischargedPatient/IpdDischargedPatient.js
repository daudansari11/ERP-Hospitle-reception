...
import IpdDischargedPatientTable from "./IpdDischargedPatientTable";
import IpdDischargedPatientForm from "./IpdDischargedPatientForm";

function IpdDischargedPatient() {
  return (
