        ...
        <div className="app-ecommerce">
          <div>
            <div className="prescription_header_sec">
              <div>
                <h4>New Visit Patient Details</h4>
              </div>
              <div>
            ...
            <div className="row">
              <div className="col-12 col-lg-12">
                <div className="card mb-4">
                  <div className="row ptt10 p-2" id="patientDetails">
                    <div className="col-md-9 col-sm-9 col-xs-9">
                      <ul className="singlelist">
                        <li className="singlelist24bold pt5">
                          <span
                            id="listname"
                        ...
                        <li>
                          <i
                            ...
                            title="Guardian"
                          />
                          <span id="guardian">Martin Wood</span>
                        </li>
                      </ul>
                      ...
                      <ul className="singlelist">
                        <li>
                          <i
                            ...
                            title="Age"
                          />
                          <span id="rage">13 Year 10 Month 7 Days</span>
                        </li>
                        <li>
                          <i
                            ...
                            title="Phone"
                          />
                          <span id="listnumber">87969078</span>
                        </li>
                        <li>
                          <i
                        ...
                        <li>
                          <b>TPA Validity</b>
                          <span id="tpa_validity" />
                        </li>
                        <li>
                          <b>National Identification Number</b>
                          <span id="identification_number" />
                        </li>
                      </ul>
                    </div>
                    <div className="col-md-3 col-sm-3 col-xs-3">
                      <img
                        ...
                        src="https://demo.smart-hospital.in/uploads/patient_images/no_image.png?1719323518"
                      />
                    </div>
                    {/* ./col-md-3 */}
                  </div>
